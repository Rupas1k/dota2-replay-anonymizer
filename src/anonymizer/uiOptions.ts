...
export const uiOptionsFromJson = (value: unknown, current = createDefaultUiOptions()): UiOptions => {
  ...
  return {
    ...
    removeLeagueInfo: booleanValue(options.remove_league_info, current.removeLeagueInfo),
    ...
    removeClicks: booleanValue(options.remove_player_clicks, current.removeClicks),
